...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_bottles = QtWidgets.QPushButton(self.verticalFrame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_bottles.sizePolicy().hasHeightForWidth())
        self.pushButton_bottles.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_bottles.setFont(font)
        self.pushButton_bottles.setStyleSheet("QPushButton{background-color: rgb(220,179,179)}")
        self.pushButton_bottles.setObjectName("pushButton_bottles")
        self.verticalLayout_2.addWidget(self.pushButton_bottles)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_bottles.setText(_translate("MainWindow", "Bottles"))
